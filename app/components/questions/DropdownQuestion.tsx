...
import { DropdownQuestion as DropdownQuestionType } from '../../types/survey';
import { FormattedTextEditor } from '../FormattedTextEditor';
import { Button } from '../ui/button';
import { ChevronDown, LayoutGrid, PlusSquare, Trash2 } from 'lucide-react';
...
interface DropdownQuestionProps {
  ...
  onChange: (question: DropdownQuestionType) => void;
  onDelete: () => void;
  onDuplicate: () => void;
      ...
      {isEditing ? (
        ...
        <div className="mb-4">
          ...
          <div className="pl-8 mt-4">
            <div className="relative bg-white border border-black rounded-sm p-3 w-full">
