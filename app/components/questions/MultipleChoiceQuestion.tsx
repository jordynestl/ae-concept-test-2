...
import { Circle, CheckCircle, LayoutGrid, PlusSquare, Trash2 } from 'lucide-react';
...
interface MultipleChoiceQuestionProps {
  ...
  onChange: (question: MultipleChoiceQuestionType) => void;
  onDelete: () => void;
  onDuplicate: () => void;
      ...
      {isEditing ? (
        <>
          ...
          <div className="flex justify-between mt-4">
            ...
            {/* Removed the Save Field button from here since it's now in the DroppableQuestion component */}
          </div>
        </>
      ) : (
        <div className="mb-4">
